...
export const finishCreateInstall = createActionCreator(
...
export const finishDeleteInstall = createActionCreator(
	constants.DELETE_INSTALL_DONE
);
...
export const finishListInstalls = createActionCreator(
	constants.LIST_INSTALL_DONE
);

export const setActiveInstall = createActionCreator(
	constants.SET_ACTIVE_INSTALL
);
export const finishSetActiveInstall = createActionCreator(
	constants.SET_ACTIVE_INSTALL_DONE
);
export const readActiveInstall = createActionCreator(
	constants.READ_ACTIVE_INSTALL
);
export const finishReadActiveInstall = createActionCreator(
	constants.READ_ACTIVE_INSTALL_DONE
);

export const checkInstallPath = createActionCreator(constants.CHECK_PATH);
export const finishCheckInstallPath = createActionCreator(
