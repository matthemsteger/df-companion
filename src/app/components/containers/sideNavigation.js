...
import {selectInstalls, setActiveInstall, listInstalls} from './../redux/modules/dwarfFortressInstalls';
...
const mapDispatchToProps = (dispatch) => bindActionCreators({setActiveInstall, listInstalls, getGeneratedWorlds}, dispatch);
